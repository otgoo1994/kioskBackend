...
router.get("/get-fav-props", auth, catchErrors(controller.getFavProps));
router.delete("/remove-fav-props", auth, catchErrors(controller.removeFavProps));
router.post('/send-report', auth, catchErrors(controller.sendReport));
